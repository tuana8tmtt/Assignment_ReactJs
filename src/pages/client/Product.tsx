...
const ProductList = (props: Props) => {
  ...
  const getPrice: SubmitHandler<any> = (data) => {
    const productPrice = products.filter(
      (item: IProduct) => item.price >= data.min && item.price <= data.max
    );
  ...
  const addToCartProduct = (data: any) => {
    ...
    message.success("Thêm vào giỏ hàng thành côngg");
  };
  return (
    <div>
      <div>
                ...
                <div>
                  ...
                  <form action="" onSubmit={handleSubmit(getPrice)}>
                    <div className="mt-4 flex items-center">
                      ...
                      />
                      <button
                        className="rounded bg-red-500 px-2 py-2 text-white ml-3"
                        type="submit"
                      >
                        Tìm
                      </button>
